      ...
      <main className='bg-black' ref={container}>
        <>
          <section className='text-white h-[70vh] w-full bg-slate-950 grid place-content-center'>
            ...
            <h1 className='text-6xl sm:text-8xl md:text-9xl px-8 font-semibold text-center tracking-tight leading-[120%] bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent'>
              Our Products
            </h1>
          </section>
        </>
