  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "hidden lg:block h-[300px] w-[530px] rounded-xl bg-transparent sticky top-24 overflow-hidden border border-white/10 shadow-[0_0_40px_-10px_rgba(255,255,255,0.1)]",
          contentClassName
        )}
      >
