...
export default function NewServicePage() {
    ...
    const onSubmit = (values: z.infer<typeof serviceSchema>) => {
        ...
        console.log(values);
        // We'll use localStorage to pass the new service to the services page
        const existingServices = JSON.parse(localStorage.getItem('services') || '[]');
        localStorage.setItem('services', JSON.stringify([...existingServices, { ...values, status: values.status ? 'Active' : 'Inactive' }]));
